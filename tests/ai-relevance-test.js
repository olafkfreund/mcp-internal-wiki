...
/**
 * AI Relevance Scoring Test
 * 
 * This script tests the AI-assisted relevance scoring functionality
 * by making queries and displaying the relevance scores in the results.
 */
...
console.log(`${colors.bright}${colors.blue}=== AI Relevance Scoring Test ===${colors.reset}\n`);
...
console.log(`${colors.cyan}Starting MCP server with AI relevance scoring...${colors.reset}`);
...
server.stdout.on('data', (data) => {
  ...
  } else if (output.includes('AI') || output.includes('relevance')) {
